...
public class SeleniumAmazonTest_old {
	public static void main(String[] args) throws InterruptedException, Exception, IOException {
		...
		try {
			...
			BufferedReader br = new BufferedReader(new FileReader(System.getProperty("user.dir") + "/test-sample.csv"));
			String line = null;
			int userListCount=1;
			while ((line = br.readLine()) != null) {
				String str[] = line.split(",");
					...
					line.replace("India", "India,"+finalRes);
